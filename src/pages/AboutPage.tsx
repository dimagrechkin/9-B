      ...
      <main className="flex-grow flex flex-col">
        ...
        <div className="container mx-auto p-4 md:p-0 text-white flex-grow">
          ...
          <section className="grid font-galindo grid-cols-1 lg:grid-cols-1 gap-4 text-white text-lg md:text-4xl text-center font-black mt-4 md:mt-8 drop-shadow-lg">
            Step into the playful world of Rugrats Coin, where the charm of your favorite cartoon characters comes alive
            in the crypto realm. Inspired by Tommy, Chuckie, and the rest of the gang, our memecoin embodies the unique
            traits that made the show unforgettable. Each transaction and interaction is infused with the spirit of
            these iconic characters, making Rugrats Coin a delightful way to engage with cryptocurrency.
          </section>
