const Analytics: React.FC = () => {
  return (
    <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow p-2.5 w-full bg-zinc-800 rounded-[30px] max-md:mt-5 max-md:max-w-full">
        <div className="flex flex-col pt-2.5 pl-2.5 max-md:max-w-full">
          <div className="flex justify-between max-md:flex-wrap">
            <h2 className="flex-1 my-auto text-2xl font-semibold tracking-tighter text-white">
              Gain Insightful Analytics
            </h2>
            <div className="flex gap-2 px-3 py-1 text-base leading-6 whitespace-nowrap bg-zinc-900 rounded-[50px] text-white text-opacity-70">
              <div className="shrink-0 rounded-full h-[30px] w-[31px]" />
              <div className="my-auto">86%</div>
            </div>
          </div>
          <p className="mt-2.5 text-base leading-6 max-w-[522px] text-white text-opacity-70 max-md:max-w-full">
            Access detailed reports to measure performance and optimize productivity
          </p>
        </div>
        <div className="flex flex-col px-2.5 pt-2.5 mt-8 text-sm font-medium leading-5 text-center whitespace-nowrap rounded-3xl bg-zinc-900 text-white text-opacity-70 max-md:max-w-full">
          <img
            loading="lazy"
