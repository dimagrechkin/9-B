...
const EfficiencyCard: React.FC<EfficiencyCardProps> = ({ title, description, imageSrc }) => {
  return (
    <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
      <div className="grow pl-5 w-full bg-zinc-800 rounded-[30px] max-md:mt-5 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto max-md:mt-10">
              <h3 className="text-2xl font-semibold tracking-tighter text-white">{title}</h3>
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center py-10 max-md:mt-5">
              <div className="flex flex-col py-3 pl-3 w-full rounded-2xl bg-zinc-900">
                <img
                  loading="lazy"
                  src={imageSrc}
                  alt={title}
